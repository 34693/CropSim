...
class Field:
    '''Simulate a field that can contain animal and crops'''
    ...
    while not valid:
        try:
            ...
            if 1 <= water <= 10:
                ...
                print("Value entered not valid - please enter a value between 1 and ten")
        except ValueError:
             print("Value entered not valid - please enter a value between 1 and ten")
    valid = False
    while not valid:
...
def display_crop_menu():
    ...
    print()
    print("Please select a option from the above menu")

def display_animal_menu():
    print()
    print("1.Which animal type would you like to add?")
    print()
    print("1.Cow")
    print("2.Sheep")
    print()
    print("0. I dont want to add a animal - Return to main menu.")
    print()
    print("Please select a option from the above menu")
...
def manage_field(field):
    ...
    while not exit:
        ...
        if option == 1:
            ...
            print("You removed the animal {0}".format(remove_animal))
        elif option == 5:
            manual_grow(field)
        elif option == 6:
            auto_grow(field)
